# -*- coding: UTF-8 -*-
from core.views import index, index1, contacts, passport, Months, Country, search_tour, moscow, ekzotika, sandom, \
    create_person_request, Ded, zagranpasport, viza, bilet, transfer, avia, strashovka, kredit, kon, koncert, gorjashhie
...
# туры по типам
    ...
    url(r'^koncert/$',koncert, name='koncert'),
    url(r'^gorjashhie-tury/$',gorjashhie, name='gorjashhie'),
                       url(r'^kon/$', kon, name='kon'),
...
# туры по типам
    ...
    url(r"^tury-po-stranam/avtobusom-k-morju/$",
        Country.as_view(tmp='avtobusom-k-morju', category_name=u'Автобусом к морю'), name='avtobusom_k_morju'),
