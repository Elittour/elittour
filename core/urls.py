...
from core.views import index, index1, contacts, passport, Months, Country, search_tour, moscow, ekzotika, sandom, \
    create_person_request, Ded, zagranpasport, viza, bilet, transfer, avia, strashovka, kredit, koncert, gorjashhie
...
# туры по типам
    ...
    url(r'^koncert/$',gorjashhie, name='gorjashhie'),
...
# туры по странам
    ...
    url(r"^tury-po-stranam/tury-po-turcii/$",
        Country.as_view(tmp='tury-po-turcii', category_name=u'Туры в Турцию'), name='turkey'),
